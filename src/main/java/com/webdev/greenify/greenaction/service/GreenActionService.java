...
public interface GreenActionService {
    ...
    GreenActionTypeResponse createActionType(CreateActionTypeRequest request);

    GreenActionTypeResponse updateActionType(String actionTypeId, UpdateActionTypeRequest request);
